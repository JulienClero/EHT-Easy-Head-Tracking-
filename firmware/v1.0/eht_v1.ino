...
// ======= NETWORK =======
const char* ssid     = "LOCAL WIFI NETWORK NAME";
const char* password = "YOUR WIFI PASSWORD";
IPAddress pcIP("YOUR PC's IP ADRESS");
const uint16_t pcPort   = 4242; //Must be the same port as in OpenTrack
WiFiUDP udp;
const uint16_t localPort = 4242; //Must be the same port as in OpenTrack
...
// Paramètres du filtre complémentaire/Complementary filter parameter
...
const unsigned long CALIBRATION_DURATION = 10000; // 10 seconds of calibration to evaluate yaw drift
